...
<tr>
<?php } ?>
<td align="center" width="<?php echo 100/$columns ?>%"><a href="photos.php?album=<?php echo $showalbumrow['albumid'].$authcode; ?>"><img src="<?php echo BASEDIRLINK; ?>albumcovers/<?php echo $showalbumrow['albumcoverphoto']; ?>" alt="" border="0" width="50" /><br /><?php echo strtolower($showalbumrow['albumname']); ?></a><?php if($edit_album == true) { ?><div style="float:right"><a href="editalbum.php?albumid=<?php echo $showalbumrow['albumid']; ?>"><img src="images/edit.gif" width="15" alt="" border="0" />Edit</a></div><?php } ?></td>
<?php
